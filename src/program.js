...
const movementInstructions = {
  ...
  "Band Face Pull": instruction("Anchor a light resistance band at face height and hold an end in each hand.", ["Draw the hands toward the temples with elbows high and ribs down.", "Squeeze the upper back briefly, then return slowly without letting the band pull you forward."]),
  ...
  "Scapular Pull-Up": instruction("Hang from a secure pull-up bar with the arms straight and feet supported if needed.", ["Keep the elbows straight and draw the shoulder blades down and back.", "Pause without shrugging, then return slowly to the relaxed hang position."]),
  ...
  "Single-Leg RDL": instruction("Stand tall on one leg with a soft knee and keep a wall nearby for support.", ["Hinge at the hip as the free leg reaches behind you, keeping the pelvis square.", "Press through the standing foot to return tall without twisting or rounding the back."]),
